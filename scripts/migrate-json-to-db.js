...
const { upsertUser, upsertProjects, upsertGithubContributions } = require(path.join(projectRoot, 'src/lib/db-queries'));
const { getGitHubProfile, getGitHubRepos, getGitHubContributions } = require(path.join(projectRoot, 'src/lib/github'));
const fs = require('fs');
